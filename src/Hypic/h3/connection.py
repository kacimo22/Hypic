...
import pylsqpack
from Hypic.buffer import UINT_VAR_MAX_SIZE, Buffer, BufferReadError, encode_uint_var
...
from Hypic.h3.exceptions import InvalidStreamTypeError, NoAvailablePushIDError
from Hypic.quic.connection import QuicConnection, stream_is_unidirectional
from Hypic.quic.events import DatagramFrameReceived, QuicEvent, StreamDataReceived
from Hypic.quic.logger import QuicLoggerTrace
...
class H3Connection:
    ...
    :param quic: A :class:`~Hypic.quic.connection.QuicConnection` instance.
    """
    ...
    def send_datagram(self, stream_id: int, data: bytes) -> None:
        ...
        :class:`~Hypic.h3.exceptions.InvalidStreamTypeError` exception is raised.
    ...
    def send_push_promise(self, stream_id: int, headers: Headers) -> int:
        ...
        :class:`~Hypic.h3.exceptions.NoAvailablePushIDError` exception is raised.
