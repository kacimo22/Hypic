...
import httpx
from Hypic.asyncio import connect
from Hypic.h0.connection import H0_ALPN
from Hypic.h3.connection import H3_ALPN, H3Connection
from Hypic.h3.events import DataReceived, HeadersReceived, PushPromiseReceived
from Hypic.quic.configuration import QuicConfiguration
from Hypic.quic.logger import QuicFileLogger, QuicLogger
...
SERVERS = [
    ...
    Server(
        "Hypic", "quic.aiortc.org", port=443, push_path="/", structured_logging=True
    ),
