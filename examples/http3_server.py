...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Catalyst server configuration file (default: server_config.json)"
    )
    parser.add_argument(
        "--port",
        type=int,
    ...
    try:
        ...
        config_file = args.catalyst_config if args.catalyst_config else "server_config.json"
        ...
        configuration.enable_pq=server_config.get_enable_pq()
